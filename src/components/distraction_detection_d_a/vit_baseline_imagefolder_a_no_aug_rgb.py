"""
This file contains DDP Implementation for the Feature Extraction/Linear Probing on Supervised Models.
...
def main(rank: int, world_size: int, config):
    ...
    train_dataset = ImageFolder(config.train_dir, transform=pretrained_vit_transforms)
    val_dataset = ImageFolder(config.val_dir, transform=pretrained_vit_transforms)
    test_dataset = ImageFolder(config.test_dir, transform=pretrained_vit_transforms)
