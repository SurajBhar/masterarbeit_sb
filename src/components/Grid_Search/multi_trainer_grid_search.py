...
from src.components.Grid_Search.grid_dataset_lr import ImageFolderCustom
import src.components.Grid_Search.grid_configs.cfg_grid_lr as cfg_loader
import src.components.Grid_Search.grid_jobs_server as server_file
...
def main(rank: int, world_size: int, config):
    ...
    train_dataset = ImageFolderCustom(config.train_dir, transform=pretrained_vit_transforms)
