...
def config_parser():
    ...
    parser.add_argument('--config', 
                        is_config_file=True, 
                        default='/home/sur06423/hiwi/vit_exp/vision_tranformer_baseline/src/components/dinov2_linear/configs/dinov2_vitb_a_rgb_no_aug/test_configs/test_configs_no_aug/combined_test_config_split_0.txt',
