...
import src.components.dinov2_linear.configs.cfg_binary_baseline as cfg_loader
...
def main(rank: int, world_size: int, config):
    ...
    log_dir = os.path.join(os.path.dirname(__file__), "dinov2_daa_experiments", config.experiment_name, "runs")
