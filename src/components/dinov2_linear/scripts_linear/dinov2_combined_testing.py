...
import src.components.dinov2_linear.configs.dinov2_vitb_a_rgb_no_aug.test_configs.test_configs_no_aug.combined_test_config_dinov2_vit_binary as cfg_loader
...
def main(rank: int, world_size: int, config):
    ...
    log_dir = os.path.join(os.path.dirname(__file__), "Donov2_vitb14_testing_d_a_no_aug", config.experiment_name, "runs")
